...
CREATE TABLE IF NOT EXISTS `VtuberMember` (
  ...
  `Twitter_Avatar` varchar(256) COLLATE utf8mb4_unicode_ci DEFAULT NULL,    
  `Twitter_Banner` varchar(256) COLLATE utf8mb4_unicode_ci DEFAULT NULL,    
  ...
  `Youtube_Banner` varchar(256) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `BiliBili_Banner` varchar(256) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
