...
func EmojiHandler(Register *ChannelRegister, s *discordgo.Session, m *discordgo.MessageReactionAdd) {
	Register.Start()
	...
	LewdLive := func(def int) {
		...
		Register.ChannelState.SetTypeTag(def)
	}
...
func EmojiUpdate(Register *ChannelRegister, s *discordgo.Session, m *discordgo.MessageReactionAdd) {
	typ := func() {
